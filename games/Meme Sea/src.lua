...
local Button = Tabs.Shop:AddButton({
    Title = "Buy baller",
    Description = "10x Balls and $10,000,000",
    Callback = function()
...
local Button = Tabs.Shop:AddButton({
    Title = "Buy aura",
    Description = "1x Meme Cube and $10,000,000",
    Callback = function()
...
local Button = Tabs.Shop:AddButton({
    ...
    Description = "1x Cheems Cola and $50,000",
    Callback = function()
...
local Button = Tabs.Shop:AddButton({
    Title = "Buy bonk",
    Description = "5x Money Bags and $1,000,000",
    Callback = function()
...
local Button = Tabs.Shop:AddButton({
    Title = "Buy banana",
    Description = "1x Cat Food and $350,000",
    Callback = function()
...
Tabs.RaidBoss:AddSection('[ Giant Pumpkin ]')
...
Tabs.RaidBoss:AddSection('[ Evil Noob ]')
...
local spawnNoobToggle = Tabs.RaidBoss:AddToggle("", {Title = "Auto spawn evil noob", Description = '', Default = false })
...
Tabs.RaidBoss:AddSection('[ Lord Sus ]')
...
Tabs.RaidBoss:AddSection('[ Meme Beast ]')
