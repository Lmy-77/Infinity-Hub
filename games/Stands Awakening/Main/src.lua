...
local damageRToggle = Tabs.Stands:AddToggle("", {Title = "Auto damage reflect", Description = 'Use to reflect the damage received. Only works in the goldem expirience requiem', Default = false })
damageRToggle:OnChanged(function(bool)
 damageReflect = bool
...
local damageDToggle = Tabs.Stands:AddToggle("", {Title = "Auto damage deflect", Description = 'Use to reflect the damage received. Only works in the goldem expirience', Default = false })
damageDToggle:OnChanged(function(bool)
 damageDeflect = bool
...
Tabs.Stands:AddSection('[ Misc ]')
local dodgeSTWToggle = Tabs.Stands:AddToggle("", {Title = "Auto dodge", Description = 'When you activate, you become intangible. You need STW', Default = false })
dodgeSTWToggle:OnChanged(function(bool)
 autoDodge = bool
 if autoDodge then
     repeat task.wait(.2)
       local args = {
     ...
     until autoDodge == false
 end
end)
local spamKnifeToggle = Tabs.Stands:AddToggle("", {Title = "Spam knife", Description = 'Activate to spam the knife', Default = false })
spamKnifeToggle:OnChanged(function(bool)
 spamKnife = bool
 if spamKnife then
     repeat task.wait(.2)
       local args = {
...
local ResetKeyBind = Tabs.Keys:CreateKeybind("Keybind", {
 Title = "Teleport Player To limbo - Keybind",
 Mode = "Toggle",
 Default = '...',
 Callback = function(Value)
      if keyBindSettings.Enabled then
